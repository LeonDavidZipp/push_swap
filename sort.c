...
/*   Updated: 2023/11/03 09:31:32 by lzipp            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "push_swap.h"

// is actually merge to b
...
static void	merge_to_b(t_stack *stack_b, t_stack *stack_a)
{
	if (stack_b->stack[0] < stack_a->stack[0])
	{
		pa_wrapper(stack_b->stack, stack_a->stack,
