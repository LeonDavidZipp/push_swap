...
/*   Updated: 2023/11/10 12:55:10 by lzipp            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	merge_to_a(t_stack *stack_a, t_stack *stack_b)
{
	...
	{
		printf("temp_a: %d, temp_b: %d, b0: %d, b1: %d\n", temp_a, temp_b, stack_a->stack[0], stack_b->stack[1]);
		temp_a = stack_a->stack[0];
		temp_b = stack_b->stack[0];
...
int main() {
    ...
    int stack_b_values[12] = {666, 200, 111, 420, 0, 0, 0, 0, 0, 0, 0};
