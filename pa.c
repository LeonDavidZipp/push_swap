...
/*   Updated: 2023/10/30 11:19:02 by lzipp            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	pa(int stack_a[], int stack_b[], int *height_a, int *height_b)
{
	if (*height_b <= 0)
		return ;
	stack_a = ft_memmove(&stack_a[1], stack_a, (size_t)(*height_a));
	stack_a[0] = stack_b[0];
	stack_b = ft_memmove(stack_b, &stack_b[1], (size_t)(*height_b));
	ft_bzero(&stack_b + *height_b, 1);
	(*height_a) += 1;
	(*height_b) -= 1;
}
